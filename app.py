...
img_file_buffer = st.camera_input("Toma la foto aquí:")
...
if img_file_buffer is not None:
   ...
   #To read image file buffer as a PIL Image:
    ...
    if prediction[0][0]>0.5:
      st.header('Rock, con Probabilidad: '+str( prediction[0][0]) )
    if prediction[0][1]>0.5:
      st.header('Corazón, con Probabilidad: '+str( prediction[0][1]))
